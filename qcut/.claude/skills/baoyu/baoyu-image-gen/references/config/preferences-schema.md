...
default_provider: null      # google|openai|dashscope|replicate|fal|null (null = auto-detect)
...
| `default_model.fal` | string\|null | null | fal.ai default model |
