...
Structure for user preferences in `.qcut-skills/qcut-slide/EXTEND.md`.
...
1. `.qcut-skills/qcut-slide/EXTEND.md` (project)
2. `$HOME/.qcut-skills/qcut-slide/EXTEND.md` (user)
