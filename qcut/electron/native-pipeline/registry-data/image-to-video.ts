...
export function registerImageToVideoModels(): void {
	...
	ModelRegistry.register({
		key: "gmi_seedance_2_0_260128_ref2v",
		name: "ByteDance Seedance 2.0 260128 Ref2V (GMI)",
		provider: "ByteDance (via GMI)",
		endpoint: "seedance-2-0-260128",
		categories: ["image_to_video"],
		description:
			"Seedance 2.0 reference-to-video: character-consistent output driven by a reference image, with optional additional references and native audio",
	...
	ModelRegistry.register({
		...
		categories: ["image_to_video"],
		description:
			"Seedance 2.0 image-to-video with first/last-frame anchoring, reference assets, and native audio",
		pricing: { per_second: 0.052 },
		durationOptions: [
			"4",
			"5",
	...
	ModelRegistry.register({
		key: "gmi_seedance_2_0_fast_260128_ref2v",
		name: "ByteDance Seedance 2.0 Fast 260128 Ref2V (GMI)",
		provider: "ByteDance (via GMI)",
	...
	ModelRegistry.register({
		key: "gmi_seedance_2_0_fast_260128_i2v",
		name: "ByteDance Seedance 2.0 Fast 260128 I2V (GMI)",
		provider: "ByteDance (via GMI)",
		endpoint: "seedance-2-0-fast-260128",
		categories: ["image_to_video"],
		description:
