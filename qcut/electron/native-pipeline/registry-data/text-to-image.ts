...
export function registerTextToImageModels(): void {
	...
	ModelRegistry.register({
		...
		description:
			"Photorealistic image generation and editing via Google Gemini 3 Pro on GMI Cloud",
		pricing: { per_image: 0.04 },
		aspectRatios: ["1:1", "4:5", "16:9", "9:16", "3:4"],
		defaults: { image_size: "2K" },
		features: ["photorealistic", "reference_image", "2K_output"],
		costEstimate: 0.04,
		processingTime: 30,
		providerBackend: "gmi",
	});
