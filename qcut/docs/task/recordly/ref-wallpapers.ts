// SOURCE: https://github.com/webadderall/Recordly/blob/main/src/lib/wallpapers.ts
// LICENSE: AGPL 3.0
// PURPOSE: Wallpaper discovery + filename utilities for plan 05 (custom backgrounds)
