// SOURCE: https://github.com/webadderall/Recordly/blob/main/src/components/video-editor/videoPlayback/cursorSway.ts
// LICENSE: AGPL 3.0
// PURPOSE: Cursor rotational wobble algorithm for plan 06
