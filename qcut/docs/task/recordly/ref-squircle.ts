// SOURCE: https://github.com/webadderall/Recordly/blob/main/src/lib/geometry/squircle.ts
// LICENSE: AGPL 3.0
// PURPOSE: iOS-style superellipse rounded corners for webcam overlay (plan 03)
