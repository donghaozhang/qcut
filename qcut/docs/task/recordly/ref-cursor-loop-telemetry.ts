// SOURCE: https://github.com/webadderall/Recordly/blob/main/src/components/video-editor/videoPlayback/cursorLoopTelemetry.ts
// LICENSE: AGPL 3.0
// PURPOSE: Smooth cursor loop return algorithm for plan 07
