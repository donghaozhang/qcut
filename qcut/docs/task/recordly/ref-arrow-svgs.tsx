// SOURCE: https://github.com/webadderall/Recordly/blob/main/src/components/video-editor/ArrowSvgs.tsx
// LICENSE: AGPL 3.0
// PURPOSE: Arrow SVG path data for 8 directions, used in plan 08 (figure annotations)
...
// Canvas2D arrow path data (for export rendering without React)
