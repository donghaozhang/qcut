# 对齐剪映时间线：任务分解（规划于动手前；T0-T6 已全部落地）
...
**状态（2026-08-18，全部在 PR #419，已随 v2026.08.18.2 发布）**：T0 ✅ T1 ✅ T2 ✅ T3 ✅ T4 ✅
...
moveElementToTrack；在所有 lane 之外的上/下方 → T4 建轨承接（lane 间
4px 缝隙视为 lane 内，不误建轨）。已知边角：选中「区间特效段」时再点特效面板会把预设挂成该
