...
Where the terminal lives in the React app, what edge functions are added on the Supabase side, and the contract between them. Companion to [`web-sandbox-architecture.md`](web-sandbox-architecture.md).
...
- [`web-sandbox-verification.md`](web-sandbox-verification.md) — once wired up, how to know it works
- [`web-sandbox-architecture.md`](web-sandbox-architecture.md) — component breakdown
- [`container-setup.md`](container-setup.md) — image structure (`qcut-entrypoint.sh` goes here)
- [`secrets-supabase.md`](secrets-supabase.md) — `agent_secrets` schema referenced above
