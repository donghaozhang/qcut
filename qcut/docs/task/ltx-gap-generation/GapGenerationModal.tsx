						...
						<div className="flex-1 overflow-auto px-5 py-4 space-y-4">
							...
							{isVideoMode && gapSettings.audio && (
								...
								>
									...
									>
										<div
											className={`absolute top-0.5 left-0.5 w-4 h-4 rounded-full bg-white shadow-sm transition-transform pointer-events-none ${
					...
					return (
						<>
							...
							>
								...
								>
									<span>Close gap</span>
									<kbd className="px-1 py-0.5 rounded bg-zinc-800 border border-zinc-700 text-zinc-500 text-[9px] font-mono leading-none">
										Del
									</kbd>
								</button>
							</div>
