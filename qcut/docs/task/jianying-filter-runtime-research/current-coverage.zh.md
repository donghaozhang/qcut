...
| 领域 | 当前状态 | 已证明 | 仍缺少 |
| --- | --- | --- | --- |
| 单 LUT / 纯调色 | 执行框架已掌握 | 596 张严格离线 native-oracle 全量执行成功，18 verified / 559 close / 19 unverified | 887 张目录卡中的 597 张 single-LUT 卡（596 张已执行 + 1 张离线缺资源）全部仍缺逐卡剪映 UI 无损 reference；产品侧需自有或获授权实现 |
