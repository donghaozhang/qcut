...
日期：2026-09-06。本机 892 张目录快照，首批 26 张迁移后剩余 198 张。

本表不是可用性承诺。`available` 只表示旧目录能力，不能算自有 Metal 已实现。
原始二进制、Shader、LUT、模型均留在仓库外；这里只记录已有目录元数据。

详见 [本轮实现与测试](independent-complex-migration-2026-09-06.zh.md)。
...
| 7127684611450178823 | 迈阿密 | 是 | 未声明 |
| 7127669342325443854 | 松果棕 | 是 | 未声明 |
| 7127668616991952158 | 贝松绿 | 是 | 未声明 |
| 7127578859217620254 | KV5D | 是 | 未声明 |
| 7239977329668263227 | 旧乐园 | 是 | blit |
| 7127669912050420999 | 老友记 | 是 | 未声明 |
...
| 7312646907908607244 | 中性II | 是 | 未声明 |
| 7312646382395936010 | 暖晨 | 是 | 未声明 |
| 7127822013074263310 | 牛皮纸 | 是 | 未声明 |
| 7221805176410180921 | 黑胶唱片 | 是 | 未声明 |
| 7160580722774920461 | 沙砾 | 是 | blit |
| 7617817255128173865 | 纸醉金迷 | 是 | 未声明 |
| 7127830050786823437 | 海鸥DC | 是 | 未声明 |
| 7127669338089311495 | 三洋VPC | 是 | 未声明 |
| 7127824119294364959 | 千玺IXU | 是 | 未声明 |
| 7447126702137904420 | 电影柔光 | 是 | 未声明 |
| 7312647197462367524 | 好莱坞IV | 是 | 未声明 |
| 7148963827239963918 | 春风 | 是 | blit |
| 7127824802819116302 | 冷透 | 是 | 未声明 |
| 7127619120761212168 | 气泡水 | 是 | 未声明 |
...
| 7356885346841349410 | 风铃II | 是 | blit, face, skin_seg |
...
| 7127609569416711455 | 侘寂灰 | 是 | blit, skin_seg |
...
| 7617811957558611206 | 小麦肌 | 是 | blit, skin_seg |
...
| 7617811803829046591 | 蜜桃肌 | 是 | blit, skin_seg |
