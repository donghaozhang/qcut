...
|---|------|-----|-------------------|----------|
| 1 | Cursor telemetry capture | [step1-cursor-telemetry.md](step1-cursor-telemetry.md) | 4 new, 4 modified | 1 day |
| 2 | Cursor renderer (PixiJS) | [step2-cursor-renderer.md](step2-cursor-renderer.md) | 6 new, 2 modified | 1 day |
