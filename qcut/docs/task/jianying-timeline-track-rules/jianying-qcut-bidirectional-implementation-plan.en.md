...
| JYI-015 – JYI-018 | ⬜ Not started | | JYI-015 is next: associate and persist an encrypted `ForeignDraftEnvelope` in the import transaction, then implement same-profile writeback behind JYR-005–007. |
...
| JYR-002 – JYR-008 research gates | ⬜ Not run | | Controlled JianYing/CapCut experiments remain required; these gates block writable paths, not the verified core-media import. |
