...
| JYI-006 – JYI-018 | ⬜ Not started | | JYI-006 (snapshot runtime package: discovery/snapshot-reader/runtime-validation) is next; its JYR-001 gate constrains real-layout assumptions only — symlink/TOCTOU/size-limit behavior tests can run against synthetic directories first |
