...
| JYI-006 ~ JYI-018 | ⬜ 未开始 | | JYI-006（snapshot runtime package：discovery/snapshot-reader/runtime-validation）为下一项；其 JYR-001 门禁只约束真实布局假设，symlink/TOCTOU/大小限制可用合成目录先行测试 |
