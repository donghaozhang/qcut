var createFFmpegCore = (() => {
  ...
  return (createFFmpegCore = {}) => {
    ...
    function mmapAlloc(size) {
      size = alignMemory(size, 65_536);
      var ptr = _emscripten_builtin_memalign(65_536, size);
      if (!ptr) return 0;
    ...
    var SOCKFS = {
      mount(mount) {
        ...
        return FS.createNode(null, "/", 16_384 | 511, 0);
      },
      createSocket(family, type, protocol) {
        ...
        var node = FS.createNode(SOCKFS.root, name, 49_152, 0);
        node.sock = sock;
        var stream = FS.createStream({
          path: name,
          node,
        ...
        createPeer(sock, addr, port) {
          ...
          if (ws) {
            ...
            try {
              ...
              WebSocketConstructor = WebSocketws = new WebSocketConstructor(
                url,
                opts
              );
    ...
    var DNS = {
      ...
      lookup_name(name) {
        ...
        if (DNS.address_map.addrs[name]) {
          ...
          assert(id < 65_535, "exceeded max address mappings of 65535");
          addr = "172.29." + (id & 255) + "." + (id & 65_280);
    ...
    function inetNtop6(ints) {
      ...
      for (word = 0; word < 8; word++) {
        ...
        str += Number(_ntohs(parts[word] & 65_535)).toString(16);
        str += word < 7 ? ":" : "";
      }
      return str;
    }
    ...
    function readI53FromI64(ptr) {
      return HEAPU32[ptr >> 2] + HEAP32[(ptr + 4) >> 2] * 4_294_967_296;
    }
    ...
    function emscripten_realloc_buffer(size) {
      var b = wasmMemory.buffer;
      try {
        wasmMemory.grow((size - b.byteLength + 65_535) >>> 16);
        updateMemoryViews();
        return 1;
      } catch (e) {}
    }
    ...
    var MAX_INT53 = 9_007_199_254_740_992;
    var MIN_INT53 = -9_007_199_254_740_992;
    ...
    var _ntohs = () => (_ntohs = Module["asm"]["wa"]).apply(null, arguments);
    var _htons = () => (_htons = Module["asm"]["xa"]).apply(null, arguments);
    ...
    var _htonl = () => (_htonl = Module["asm"]["Aa"]).apply(null, arguments);
    ...
    var ___cxa_is_pointer_type = () =>
      (___cxa_is_pointer_type = Module["asm"]["Fa"]).apply(null, arguments);
    var _ff_h264_cabac_tables = (Module["_ff_h264_cabac_tables"] = 1_546_732);
    var ___start_em_js = (Module["___start_em_js"] = 6_077_485);
    var ___stop_em_js = (Module["___stop_em_js"] = 6_077_662);
