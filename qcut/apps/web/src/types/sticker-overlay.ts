...
export interface StickerOverlayActions {
  // CRUD Operations
  addOverlaySticker: (mediaItemId: string, options?: Partial<OverlaySticker>) => string;
 ...
 */
export type ValidatedStickerUpdate = Partial<Omit<OverlaySticker, 'id' | 'mediaItemId'>>;
