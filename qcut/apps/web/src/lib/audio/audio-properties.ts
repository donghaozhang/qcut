...
> = {
	volumeDb: { label: "音量", min: -60, max: 12, step: 0.1, suffix: "dB" },
	fadeIn: { label: "淡入", min: 0, max: 30, step: 0.1, suffix: "s" },
	fadeOut: { label: "淡出", min: 0, max: 30, step: 0.1, suffix: "s" },
	pan: { label: "声像平衡", min: -100, max: 100, step: 1, suffix: "%" },
	denoiseAmount: {
		label: "降噪强度",
		min: 0,
		max: 100,
	...
	voiceClarity: { label: "清晰度", min: -100, max: 100, step: 1, suffix: "%" },
	voiceWarmth: { label: "温暖度", min: -100, max: 100, step: 1, suffix: "%" },
	voicePresence: {
		label: "临场感",
		min: -100,
		max: 100,
	...
	pitchSemitones: { label: "音调", min: -12, max: 12, step: 1, suffix: "st" },
	eqLowGainDb: { label: "低频", min: -18, max: 18, step: 0.5, suffix: "dB" },
	eqMidGainDb: { label: "中频", min: -18, max: 18, step: 0.5, suffix: "dB" },
	eqHighGainDb: {
		label: "高频",
		min: -18,
		max: 18,
	...
	reverbMix: { label: "混响比例", min: 0, max: 100, step: 1, suffix: "%" },
	echoMix: { label: "回声比例", min: 0, max: 100, step: 1, suffix: "%" },
};
