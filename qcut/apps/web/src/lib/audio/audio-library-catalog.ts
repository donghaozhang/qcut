...
function builtInAudio({
	...
	// Covers are generated by apps/web/scripts/generate-builtin-audio-artwork.ts
	const artworkUrl = `/audio/builtin/artwork/${fileName}.webp`;
	return {
		id,
		name,
		localizedName,
...
export function restoreSavedAudio({
	...
	return {
		...
		artworkUrl: savedSound.artworkUrl,
		bpm: savedSound.bpm,
