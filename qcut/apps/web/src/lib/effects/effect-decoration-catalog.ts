...
export const DECORATION_EFFECT_CATALOG = [
	...
	createDecorationCatalogEntry({
		id: "basic-cinema-bars",
		name: "Cinema Bars",
		localizedName: "电影感画幅",
		description: "Fixed black bars that crop the frame to a 2.8:1 window.",
		localizedDescription: "上下固定黑边，把画面裁成 2.8:1 的电影宽幅。",
		category: "basic",
		icon: "CB",
		variant: "letterbox",
		color: "#000000",
		opacity: 1,
		tags: ["letterbox", "cinema", "frame", "basic"],
