...
export { computeRegionStrength, mergeOverlappingRegions } from "./zoom-region-utils";
...
export { analyzeForZoomSuggestions, DEFAULT_AUTO_ZOOM_CONFIG } from "./auto-zoom-analyzer";
