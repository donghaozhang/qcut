		...
		<div className="flex justify-center gap-4 leading-16">
			<div ref={containerRef} className="relative -rotate-[2.76deg] mt-0.5">
				<div className="absolute inset-0 w-full h-full rounded-2xl border border-yellow-500 flex justify-between z-1">
					<motion.div
						className="absolute z-10 left-0 h-full border border-yellow-500 w-7 rounded-full bg-black flex items-center justify-center select-none"
						style={{
							x: leftHandleX,
						}}
						drag="x"
					...
					<motion.div
						className="absolute z-10 -left-[30px] h-full border border-yellow-500 w-7 rounded-full bg-black flex items-center justify-center select-none"
						style={{
							x: rightHandleX,
						}}
						drag="x"
