...
import { editImage, uploadImageToFAL, type ImageEditRequest } from '@/lib/image-edit-client';
    ...
    try {
      ...
      if (result.status === 'completed' && result.result_url) {
        ...
        try {
          ...
          const downloadedFile = await downloadImageAsFile(result.result_url, filename);
          ...
          console.error('❌ Failed to add edited image to media library:', error);
