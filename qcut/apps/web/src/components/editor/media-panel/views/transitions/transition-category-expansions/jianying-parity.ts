...
import { JIANYING_EXTRA_PARITY_EXPANSIONS } from "./jianying-parity-extras";
import { JIANYING_MASK_PARITY_EXPANSIONS } from "./jianying-parity-masks";

/**
 * JianYing-parity parameter sweep: named looks from 剪映's 热门/叠化/运镜/
 * 光效/故障/综艺/模糊/幻灯片/自然/拍摄 shelves, expressed entirely through
 * the existing clip transition engines with tuned direction/intensity/
 * frequency/tint. Mask-shape and later-round groups live in
 * jianying-parity-masks.ts and jianying-parity-extras.ts.
 */
...
export const JIANYING_PARITY_TRANSITION_EXPANSIONS: TransitionPreset[] = [
	...
	...naturalParity,
	...shootingParity,
	...JIANYING_MASK_PARITY_EXPANSIONS,
	...JIANYING_EXTRA_PARITY_EXPANSIONS,
];
